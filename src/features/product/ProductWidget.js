  ...
  return (
    <div className=" bg-#fbebee">
      <div className="flex justify-center mt-20">
          <div className="container h-441px min-w-324 w-80 pl-12 pt-11 pr-10 pb-24 drop-shadow-xl bg-white">
              <div>
                  <h1 className="font-medium text-2xl">{product?.title}</h1>
                  <h2 className="uppercase font-medium text-base pt-2">{product?.category}</h2>
              </div>
              <div className="pt-6">
              ...
              <div className="flex flex-row justify-between pt-10 mr-75px">
                <div className="relative inline-block rounded">
                  <NumericInput min={0} max={100} value={1} format={myFormat} className="w-14 h-8 bg-gray text-white outline-none text-center rounded-sm"/>
                </div>
