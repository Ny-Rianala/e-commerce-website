  ...
  return (
    <div className=" bg-#fbebee">
        <div className="container mx-auto bg-backgroundContainer h-441px min-w-324 w-80 pl-12 pt-11 pr-10 pb-24 drop-shadow-xl">
          <div>
            <h1 className="font-bold text-xl text-headingColor">{product?.title}</h1>
            <h2 className="uppercase text-xs font-extrabold text-subHeadingColor pt-2">{product?.category}</h2>
          </div>
          <div className="pt-6">
          ...
          <div className="flex flex-row justify-between pt-12">
            ...
            <div className="flex flex-row justify-between text-0.6rem text-paragraphColor">
